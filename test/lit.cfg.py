...
config.test_exec_root = os.path.join(config.zkir_obj_root, 'test')
...
# test_exec_root: The root path where tests should be run.
config.test_exec_root = os.path.join(config.zkir_obj_root, 'test')
config.zkir_tools_dir = os.path.join(config.zkir_obj_root, 'bin')

# Tweak the PATH to include the tools dir.
llvm_config.with_environment('PATH', config.zkir_tools_dir, append_path=True)
